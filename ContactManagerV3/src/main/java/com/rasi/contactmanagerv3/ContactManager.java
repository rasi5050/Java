...
//        prepared statement to parameterize SQL
    ...
    // Method to parse JSON input to Contact object
    Contact parseJsonToContact(String jsonString) {
...
//    update
    ...
    void update(Integer id, Contact contact) throws SQLException {


//        update implemented as delete and new insert
        delete(id);
//        delete is failing, its actually not deleting, earlier it was deleted using contact, then its, id, now the process is incomplete
        insert(contact);
    }
